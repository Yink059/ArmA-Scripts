...
class groupManager
{
	...
	class frame_right: YinkRscFrame
	{
		idc = 1801;
	...
	class text_title: YinkRscText
	{
		...
		tooltip = "Create/Manage current groups";
		moving = 1;
	};
	class text_title_left_lb: YinkRscText
	{
		idc = 1001;
	...
	class text_title_current: YinkRscText
	{
		idc = 1002;
	...
	class text_current: YinkRscText
	{
		idc = 1003;
	...
	class text_title_current_leader: YinkRscText
	{
		idc = 1004;
	...
	class text_current_leader: YinkRscText
	{
		idc = 1005;
		text = "<nil>"; //--- ToDo: Localize;
		x = 20 * GUI_GRID_W + GUI_GRID_X;
	...
	class button_join: YinkRscButton
	{
		idc = 1600;
	...
	class text_title_right_lb: YinkRscText
	{
		idc = 1006;
	...
	class button_new_group: YinkRscButton
	{
		idc = 1601;
	...
	class button_kick_right_lb: YinkRscButton
	{
		idc = 1602;
	...
	class button_right_invite_lb: YinkRscButton
	{
		idc = 1603;
	...
	class editbox_left_input: YinkRscEdit
	{
		idc = 2501;
		...
		h = 1 * GUI_GRID_H;
		autocomplete = "";
		onKeyDown = "if ((_this select 1)==28) then {action1 = [player] spawn fnc_yink_changeName};";
		tooltip = "Press Enter or the button below to apply"; //--- ToDo: Localize;
	};
	class button_apply_name: YinkRscButton
	{
		idc = 2502;
