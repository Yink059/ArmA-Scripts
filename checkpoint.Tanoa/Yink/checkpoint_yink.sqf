...
//////////////////////////////create function for arresting, forces to surrender
	_arrested = {
		...
		_wep	= _veh getVariable "wep";
		_bomb	= _veh getVariable "bomb";
		if (!((_unit hasWeapon "hgun_P07_F")||(_wep)||(_bomb)))  then {
			[
				_unit,
				{///////////////////////////////////////////////if is not an insurgent
					doGetOut _this;
		...
		} else {////////////////////////////////////////////////if wants to run and doesnt have a weapon
			if ((_run==1)&&(!(_unit hasWeapon "hgun_P07_F"))) then {
				[
					_unit,
					{
						doGetOut _this;
			...
			} else {////////////////////////////////////////////if is armed and doesnt run
				...
				} else {//////////////////////////////////////////////if is not armed and doesnt run
					[
						_unit,
						{
							doGetOut _this;
...
///////////////////////////////////////////create vehicle action	
	_detainIndex = _veh addAction [
		...
		[_arrested,_spawn,_jail],
		0,
		true,
		true,
		"",
		"((side (driver _target))==resistance)&&((count crew _target)>0)",
		6,
		false
	];
